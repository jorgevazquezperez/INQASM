...
void InQuIRtoNetQASMListener::closeFile(bool finish_process) {
    ...
    if(stoi(branches_counter) > 0){
        nqasm_name1 = "process_" + current_process_num + "_1.nqasm";
        nqasm_name2 = "process_" + current_process_num + "_2.nqasm";
        info_name = "process_" + current_process_num + "_" + branches_counter + ".yaml";
    } else {
        nqasm_name1 = "process_" + current_process_num + ".nqasm";
    }
    ...
    if (out_file1.is_open()) {
        ...
        if(stoi(branches_counter) > 0) {
            std::ofstream out_file2(nqasm_name1);
            out_file2.close();
